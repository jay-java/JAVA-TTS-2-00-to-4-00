...
public class HomeController {
	...
	@GetMapping("/userbyenp")
	public User getUserById(@RequestParam("email") String email, @RequestParam("password") String password) {
		return this.service.getUserByEmailNPass(email, password);
	}

	@PutMapping("/user")
	public User updateUser(@RequestBody User u) {
		return this.service.updaeUser(u);
	}
}
