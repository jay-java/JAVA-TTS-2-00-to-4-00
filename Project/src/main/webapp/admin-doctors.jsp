...
<!-- Mirrored from demo.dashboardpack.com/cryptocurrency-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Oct 2025 09:25:37 GMT -->
<head>
<!-- Required meta tags -->
<meta charset="utf-8" />
<meta name="viewport"
...
<body class="crm_body_bg">
	...
	<nav class="sidebar dark_sidebar">
		<div class="logo d-flex justify-content-between">
			<a class="large_logo" href="index-2.html"><img
				src="admin/img/logo_white.png" alt=""></a> <a class="small_logo"
				href="index-2.html"><img src="admin/img/mini_logo.png" alt=""></a>
		...
		<ul id="sidebar_menu">
			...
			<li class=""><a href="admin-home.jsp" aria-expanded="false">
			...
			<li class=""><a href="admin-doctors.jsp" aria-expanded="false">
					<div class="nav_icon_small">
			...
			<li class=""><a href="Trader_Profile.html" aria-expanded="false">
					<div class="nav_icon_small">
			...
			<li class=""><a href="crypto_stats.html" aria-expanded="false">
					<div class="nav_icon_small">
						...
						<div
							...
							<div class="header_notification_warp d-flex align-items-center">
								<li><a class="CHATBOX_open nav-link-notify" href="#"> <img
										src="admin/img/icon/msg.svg" alt="">
								</a></li>
								<li><a class="bell_notification_clicker nav-link-notify"
									href="#"> <img src="admin/img/icon/bell.svg" alt="">
										<!-- <span>2</span> -->
								</a> <!-- Menu_NOtification_Wrap  -->
								...
								<div class="QA_section">
									...
									<div class="QA_table mb_30">
										...
										<table class="table lms_table_active3 ">
											...
											<tbody>
												<%
												List<Doctor> dlist = DoctorDao.getAllDoctors();
												%>
												<%
												for (Doctor d : dlist) {
												%>
												<tr>
													<th scope="row"><a href="#" class="question_content">
															<%=d.getId()%></a></th>
													<td><img alt="" src="imagess/<%=d.getImage()%>" height="100" width="100"></td>
													<td>Teacher James</td>
													<td>Lessons name</td>
													<td>16</td>
													<td>$25.00</td>
						...
						<div
							...
							<div class="monitor_list_widget">
								...
								<div class="simgle_monitor_list">
									...
									<h4>
										$ <span class="counter">55,250</span>
									</h4>
								</div>
								<div class="simgle_monitor_list">
									<div class="simgle_monitor_count d-flex align-items-center">
									...
									<h4>
										$ <span class="counter">451.6 </span>M
									</h4>
								</div>
							</div>
						</div>
							...
							<div class="white_card_header ">
								<div class="box_header m-0">
									<ul class="nav  theme_menu_dropdown">
										<li class="nav-item"><a class="nav-link active" href="#">Analytics</a>
										</li>
										<li class="nav-item"><a class="nav-link" href="#">Cryptocurrency</a>
										</li>
										<li class="nav-item"><a class="nav-link" href="#">Campaign</a>
										</li>
										<li class="nav-item dropdown"><a
											...
											<div class="dropdown-menu">
												<a class="dropdown-item" href="#"> Ecommarce Analytics</a> <a
													class="dropdown-item" href="#"> Sales</a> <a
													class="dropdown-item" href="#"> Performance</a>
											</div></li>
									</ul>
									<div class="button_wizerd">
										<a href="#" class="white_btn mr_5">ToDo</a> <a href="#"
											class="white_btn">Settings</a>
									</div>
								</div>
							</div>
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="single_analite_content">
											<h4>Total Income</h4>
											<h3>
												$ <span class="counter">14,025</span>
											</h3>
											<div class="d-flex">
												<div>
													3.78 <i class="fa fa-caret-up"></i>
												</div>
												<span>This year</span>
											</div>
										</div>
					...
					<div class="col-12">
						<div
							...
							<div class="page_title_left mb_10">
								...
								<p>Statistics, Predictive Analytics Data Visualization, Big
							...
							<div class="white_card_header">
								<div class="box_header m-0 flex-wrap">
									...
									<div class="view_btns">
										...
										<a href="#" class="mr_5 mb_10  small_blue_btn active">1M</a> <a
											href="#" class="mr_5 mb_10  small_blue_btn">6M</a> <a
											href="#" class="mr_5 mb_10  small_blue_btn">1Y</a> <a
											href="#" class="mr_5 mb_10  small_blue_btn">YTD</a>
									</div>
								</div>
							</div>
							<div class="white_card_body">
						...
						<div class="white_card card_height_100 mb_30">
									...
									<div class="header_more_tool">
										<div class="dropdown">
											<span class="dropdown-toggle" id="dropdownMenuButton"
												data-bs-toggle="dropdown"> <i class="ti-more-alt"></i>
											</span>
											<div class="dropdown-menu dropdown-menu-right"
												aria-labelledby="dropdownMenuButton">
												<a class="dropdown-item" href="#"> <i class="ti-eye"></i>
													Action
												</a> <a class="dropdown-item" href="#"> <i class="ti-trash"></i>
													Delete
							...
							<div class="white_card_body">
								...
								<div class="social_media_list">
									<div
										class="single_media d-flex justify-content-between align-items-center">
										<span class="mediaName"> <img src="img/currency/1.svg"
											alt=""> Bitcoin
										</span> <span class="earning_amount">
											<h4>0.000242 BTC</h4>
											<p>0.125 USD</p>
										</span>
									</div>
									<div
										class="single_media d-flex justify-content-between align-items-center">
										<span class="mediaName"> <img src="img/currency/2.svg"
											alt=""> Litecoin
										</span> <span class="earning_amount">
											<h4>0.000242 BTC</h4>
											<p>0.125 USD</p>
									...
									<div
										class="single_media d-flex justify-content-between align-items-center">
										<span class="mediaName"> <img src="img/currency/3.svg"
											alt=""> Ripple
										</span> <span class="earning_amount">
											<h4>0.000242 BTC</h4>
											<p>0.125 USD</p>
									...
									<form name="myform" class="currency_validate">
										<div class="form-group">
											...
											<div class="input-group ">
												...
												</select> <input type="text" name="usd_amount" class="form-control"
													value="125.00 USD">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" name="currency_amount"
													class="form-control" placeholder="0.0214 BTC"> <input
													type="text" name="usd_amount" class="form-control"
									...
									<div class="QA_table mb-0 transaction-table">
										...
										<div class="table-responsive">
											<table class="table  ">
												<tbody>
													<tr>
														<td scope="row"><span class="sold-thumb"><i
																class="ti-arrow-up"></i></span></td>
														<td><span class="badge bg-danger">Sold</span></td>
														<td><img class="small_img" src="img/currency/1.svg"
															alt=""> Bitcoin</td>
													...
													<tr>
														<td scope="row"><span class="buy-thumb"><i
																class="ti-arrow-down"></i></span></td>
														<td><span class="badge bg-success">Buy</span></td>
														<td><img class="small_img" src="img/currency/2.svg"
															alt=""> Bitcoin</td>
														<td>Using - Bank......4585</td>
														<td>-0.000234 BTC</td>
														<td>-0.454 USD</td>
													...
													<tr>
														<td scope="row"><span class="sold-thumb"><i
																class="ti-arrow-up"></i></span></td>
														<td><span class="badge bg-danger">Sold</span></td>
														<td><img class="small_img" src="img/currency/4.svg"
															alt=""> Bitcoin</td>
														<td>Using - Bank......4585</td>
														<td>-0.000234 BTC</td>
														<td>-0.454 USD</td>
													...
													<tr>
														<td scope="row"><span class="sold-thumb"><i
																class="ti-arrow-up"></i></span></td>
														<td><span class="badge bg-danger">Sold</span></td>
														<td><img class="small_img" src="img/currency/3.svg"
															alt=""> Bitcoin</td>
														<td>Using - Bank......4585</td>
														<td>-0.000234 BTC</td>
														<td>-0.454 USD</td>
								...
								<div class="news_widget_wrap">
									<div class="single_news mb_20">
										<div class="thumb mb_20">
											<a href="#"><img class="img-fluid" src="img/news/1.svg"
												alt=""></a>
										</div>
										<a href="#">
											<p class="f_s_18 f_w_400">Aorem psum dolor sit amet,
												consect adipisci Quisque scelerisq.</p>
										</a>
									</div>
									<div class="single_news mb_20">
										<div class="thumb mb_20">
											<a href="#"><img class="img-fluid" src="img/news/2.svg"
												alt=""></a>
										</div>
										<a href="#">
											<p class="f_s_18 f_w_400">Aorem psum dolor sit amet,
	...
	<div id="back-top" style="display: none;">
		<a title="Go to Top" href="#"> <i class="ti-angle-up"></i>
		</a>
	</div>
...
<!-- Mirrored from demo.dashboardpack.com/cryptocurrency-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Oct 2025 09:26:19 GMT -->
</html>
