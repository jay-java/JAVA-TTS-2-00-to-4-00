				...
				<div class="collapse navbar-collapse" id="navbarmain">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link"
							href="patient-home.jsp">Home</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown03">
								<li><a class="dropdown-item"
									href="patient-pending-appointments.jsp">Pending</a></li>
								<li><a class="dropdown-item"
									href="patient-complete-appointments.jsp">Completed </a></li>
							</ul></li>
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="doctor.html"
							id="dropdown03" data-toggle="dropdown" aria-haspopup="true"
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown03">
								<li><a class="dropdown-item"
									href="patient-orthopedic-doctors.jsp">Orthopedic</a></li>
								<li><a class="dropdown-item"
									href="patient-Gastrology-doctors.jsp">Gastrology </a></li>
							</ul></li>
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="doctor.html"
							id="dropdown03" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"><%=d.getName()%> <i
								class="icofont-thin-down"></i></a>
							<ul class="dropdown-menu" aria-labelledby="dropdown03">
								<li><a class="dropdown-item" href="doctor-profile.jsp">Profile</a></li>
								<li><a class="dropdown-item"
									href="doctor-change-password.jsp">Change Password </a></li>
