					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu" aria-labelledby="dropdown03">
								<li><a class="dropdown-item" href="doctor-registration.jsp">Registration</a></li>
								<li><a class="dropdown-item" href="doctor-login.jsp">Login
								</a></li>
							</ul></li>
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="doctor.html"
							id="dropdown03" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false">Patient <i class="icofont-thin-down"></i></a>
							<ul class="dropdown-menu" aria-labelledby="dropdown03">
								<li><a class="dropdown-item"
									href="patient-registration.jsp">Registration</a></li>
								<li><a class="dropdown-item" href="patient-login.jsp">Login
								</a></li>
							</ul></li>
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false">Admin <i class="icofont-thin-down"></i></a>
							<ul class="dropdown-menu" aria-labelledby="dropdown05">
								<li><a class="dropdown-item" href="admin-login.jsp">Login</a></li>
